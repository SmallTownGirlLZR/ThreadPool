...
class AgentRunner:
    ...
    def __init__(
        ...
        *,
        ...
        self._task_registry = BackgroundTaskRegistry()      # [run_id, (asyncio.Task, ExecutionContext)]
    ...
    def _build_registry(
        ...
        *,
        ...
        # if tool_whitelist is None or empty, no restriction, so the LLM can use all normally registered tools.
        ...
        # The child needs a parent run ID so its events and relationship to the parent run can be tracked.
        ...
        *,
        ...
        async with EventWriter(run_path / "events.jsonl") as writer:
            ...
            try:
                ...
                # This code chooses where child-agent run data should be stored
                child_runs_dir = (
