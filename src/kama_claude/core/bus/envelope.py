...
# the envelope.py module defines the data structures used for JSON-RPC communication between the core daemon and clients. It includes request, response, and error formats, as well as an event push envelope for sending events.
...
"""
# Wrap events that are pushed from the core daemon to clients. 
