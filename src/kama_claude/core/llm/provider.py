...
class AnthropicProvider:
    ...
    async def chat(
        ...
        *,
        ...
        context_pct = usage.input_tokens / _context_window(self._model)     # The output is therefore accounted for when it becomes history, rather than being counted immediately and then counted again on the next request.
