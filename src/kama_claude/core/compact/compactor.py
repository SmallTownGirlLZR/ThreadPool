...
class CompactionResult:
    summary_text: str       # It later replaces the old message history as the new condensed context.
    original_token_estimate: int    # A rough estimate of how many tokens the original conversation used before compaction.
    summary_tokens: int     # The number of tokens in the compacted summary.
...
<tool_call name=list_dir id=toolu_123>
{'path': '.', 'max_depth': 2}
</tool_call>
...
[ASSISTANT]
I found the main source files under src/.
"""
